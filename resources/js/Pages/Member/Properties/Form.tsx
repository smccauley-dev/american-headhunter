...
export default function PropertyForm({ property, states, statuses }: Props) {
  ...
  return (
    <PortalChrome headTitle={isEdit ? `Edit · ${property!.title}` : 'New Property'}>

      <BackLink href="/member/profile">← Back to Profile</BackLink>
        ...
        <Section title="Manage Property">
          <div style={{ display: 'flex', gap: '10px', flexWrap: 'wrap' }}>
            <a
              ...
              style={{ display: 'inline-flex', alignItems: 'center', gap: '8px', fontFamily: 'var(--mono)', fontSize: '10px', fontWeight: 700, letterSpacing: '.1em', textTransform: 'uppercase', padding: '11px 26px', background: ACCENT, color: '#fff', textDecoration: 'none' }}
            >
              Manage Listings →
            </a>
            <a
            ...
            <a
              href={`/member/properties/${property.id}/details?tab=team`}
              style={{ display: 'inline-flex', alignItems: 'center', gap: '8px', fontFamily: 'var(--mono)', fontSize: '10px', fontWeight: 700, letterSpacing: '.1em', textTransform: 'uppercase', padding: '11px 26px', background: 'transparent', color: INK, border: `1px solid ${TAN}`, textDecoration: 'none' }}
            >
              Manage Team →
            </a>
