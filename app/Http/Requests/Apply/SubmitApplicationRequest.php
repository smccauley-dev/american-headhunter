...
class SubmitApplicationRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'hunters.*.dl_expiry'        => ['required', 'date', 'after_or_equal:today'],
            ...
            'hunters.*.hunting_license_expiry'           => ['required', 'date', 'after_or_equal:today'],
    ...
    public function messages(): array
    {
        return [
            ...
            'hunters.*.dl_expiry.after_or_equal' => 'This driver\'s license has expired. Please provide a current license.',
            ...
            'hunters.*.hunting_license_expiry.after_or_equal' => 'This hunting license has expired. Please provide a current license.',
