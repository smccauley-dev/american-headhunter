        ...
        return [
            ...
            Action::make('approve')
                ...
                ->action(function (LeaseApplication $record, array $data): void {
                    ...
                    $property = Property::on('property')->find($record->property_id_snapshot);
                    if (! $property) {
                        Notification::make()
                            ->title('Property record not found — lease not created')
                            ->body('The property snapshot on this application could not be resolved. Check the property exists in the property database.')
                            ->danger()
                            ->send();
                        return;
                    }
