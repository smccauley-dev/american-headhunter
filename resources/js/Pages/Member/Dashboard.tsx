...
const QUICK_LINKS = [
  ...
  },
  {
    label: 'Harvest Log',
    href: '/member/harvest',
    desc: 'Log harvests, track quotas and CWD rules',
    icon: (
  ...
  },
  {
    ...
    href: '/member/sightings',
    desc: 'Log the animals you see in the field',
    icon: (
  ...
  },
  {
    label: 'Fishing Log',
    href: '/member/fishing',
    desc: 'Log the fish you land on your lease water',
    icon: (
