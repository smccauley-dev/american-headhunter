...
Route::middleware('auth.session')->prefix('member')->name('member.')->group(function () {
    ...
    // Landowner terminates an active lease for a hunter's violation: forfeits the
    // deposit (a contestable claim) and forfeits/refunds prepaid rent per the lease's
